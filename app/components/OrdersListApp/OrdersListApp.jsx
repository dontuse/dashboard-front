...
import OrdersFolders from '../OrdersFolders/OrdersFolders';
...
class OrdersListApp extends React.Component {
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <div className={b('do-orders-list-app')}>
        <OrdersFolders location={this.props.location} />
...
export default connect(mapStateToProps)(OrdersListApp);
